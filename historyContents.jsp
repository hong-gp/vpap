...
<center>
    <br><br>
	<font color="white" size='5'><b>내가 시청한 콘텐츠</b></font><p><br>
    <hr style="width:75%;">
<%
try {
	...
	String jsql = "SELECT * FROM history WHERE memId=?";
...
<%
		...
		String jsql2 = "SELECT * FROM history WHERE memId=?";
