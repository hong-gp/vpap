...
<form method="post" action = "idOk.jsp">
	<div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
		<div class="head" style="font-weight: bold; text-align: center;">아이디 찾기</div><br>
		<div>
		...
		<br>
		<input type="submit" value="아이디 찾기" style="width: 100%; font-weight: bold;">
	</div>
</form>
</body>
</html>